...
// 2022: DraftKings opening lines (key teams confirmed via web; gaps from published consensus).
// 2023: Caesars Sportsbook opening lines (confirmed via web sources, all 32 teams).
// 2024: DraftKings opening lines (~20 teams confirmed via web; gaps from published consensus).
...
export const historicalVegasLines: Record<string, Record<string, number>> = {
  ...
  "2022": { ARI:9.0,ATL:5.5,BAL:9.5,BUF:11.5,CAR:5.5,CHI:7.0,CIN:10.5,CLE:9.0,DAL:9.5,DEN:9.5,DET:5.0,GB:11.0,HOU:4.5,IND:7.5,JAX:5.5,KC:11.0,LAC:9.5,LAR:11.5,LV:8.5,MIA:8.5,MIN:7.5,NE:9.0,NO:8.0,NYG:7.5,NYJ:5.5,PHI:9.5,PIT:8.0,SEA:5.5,SF:9.5,TB:11.0,TEN:10.5,WAS:7.0 },
  ...
  "2024": { ARI:8.5,ATL:7.5,BAL:11.0,BUF:11.5,CAR:4.5,CHI:8.5,CIN:9.5,CLE:7.5,DAL:9.5,DEN:7.5,DET:10.5,GB:8.5,HOU:9.5,IND:8.0,JAX:9.0,KC:11.5,LAC:8.5,LAR:9.5,LV:5.5,MIA:9.0,MIN:7.5,NE:4.5,NO:7.5,NYG:6.5,NYJ:7.5,PHI:10.5,PIT:8.5,SEA:7.5,SF:11.5,TB:9.0,TEN:5.5,WAS:7.5 },
