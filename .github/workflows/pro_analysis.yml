      ...
      - name: Send Email
        ...
        run: |
          ...
          <div style="background:#e8f4f8; padding:15px; border-left:4px solid #0066cc; margin:20px 0;">
              <h2 style="margin-top:0;">📊 Sharp Money Intelligence</h2>
              <ul>
          ...
          <div style="background:#f8f9fa; padding:10px; border-left:4px solid #6c757d; margin:20px 0;">
              <p style="margin:0;"><b>💡 Quick Start:</b> Executive Summary shows top plays. Full Pro Analysis available in GitHub artifacts.</p>
          </div>
