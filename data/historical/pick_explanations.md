...
|---|---|---|---|---|---|---|
| W2 CAR@ATL | play | play | total | OVER | standard | Selector isolated total OVER; Signals: sharp, ref_weather_context; WARPS moneyline overlay: HOME +33.3% EV |
| W2 CLE@TB | play | play | spread | HOME | standard | Selector isolated spread HOME; Signals: sharp, team_rating; Value-gap alignment supports the side; WARPS fair-line prior conflicts toward AWAY; WARPS moneyline overlay: AWAY +53.8% EV |
| W2 IND@KC | play | play | spread | HOME | standard | Selector isolated spread HOME; Signals: sharp, team_rating; Value-gap alignment supports the side; WARPS fair-line prior conflicts toward AWAY; WARPS moneyline overlay: AWAY +48.2% EV |
...
| W2 DET@BUF | lean | watch |  |  | watch | Signals: sharp; WARPS moneyline overlay: AWAY +30.1% EV |
| W2 GB@NYJ | lean | watch |  |  | watch | Signals: sharp, team_rating; WARPS moneyline overlay: HOME +11.5% EV |
| W2 MIN@CHI | lean | watch |  |  | watch | Signals: sharp; WARPS moneyline overlay: AWAY +29.4% EV |
| W2 NO@BAL | lean | watch |  |  | watch | Signals: sharp, team_rating; WARPS moneyline overlay: AWAY +50.7% EV |
...
| W2 SEA@ARI | lean | watch |  |  | watch | WARPS moneyline overlay: HOME +7.4% EV |
...
| W2 CIN@HOU | pass | pass |  |  | none | WARPS moneyline overlay: HOME +11.9% EV |
| W2 LV@LAC | lean | watch |  |  | watch | Signals: sharp; WARPS moneyline overlay: AWAY +11.2% EV |
| W2 MIA@SF | pass | pass |  |  | none | WARPS moneyline overlay: AWAY +161.9% EV |
| W2 NYG@LAR | pass | pass |  |  | none | WARPS moneyline overlay: AWAY +20.5% EV |
| W2 PHI@TEN | pass | pass |  |  | none | WARPS moneyline overlay: HOME +49.9% EV |