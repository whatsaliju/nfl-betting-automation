...
| WPRE2 CAR@JAX | pass | pass |  |  | none | Promoted factors matched: 1; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 CHI@CIN | pass | pass |  |  | none | Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 DAL@ARI | lean | watch |  |  | watch | Signals: sharp; Promoted factors matched: 1; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 GB@DEN | pass | pass |  |  | none | Promoted factors matched: 1; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 KC@TB | pass | pass |  |  | none | Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 LV@HOU | pass | pass |  |  | none | Promoted factors matched: 2; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 NO@LAR | pass | pass |  |  | none | Promoted factors matched: 2; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 NYG@MIA | pass | pass |  |  | none | Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
| WPRE2 PHI@NE | pass | pass |  |  | none | Promoted factors matched: 1; Source warning: source_health_status=DEGRADED, data_quality_status=DEGRADED |
...
| WWC HOU@PIT | pass | pass |  |  | none | Promoted factors matched: 1 |
| WWC LAC@NE | pass | pass |  |  | none | Promoted factors matched: 1 |
| WWC LAR@CAR | pass | pass |  |  | none | Promoted factors matched: 1 |
| WWC SF@PHI | pass | pass |  |  | none | No isolated selector edge |