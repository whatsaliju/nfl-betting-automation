...
|---|---|---|---|---|---|---|
| W2 CAR@ATL | play | play | total | OVER | standard | Selector isolated total OVER; Signals: sharp, ref_weather_context; WARPS moneyline overlay: HOME +892.2% EV |
...
| W2 GB@NYJ | play | play | spread | HOME | standard | Selector isolated spread HOME; Signals: sharp, team_rating; Value-gap alignment supports the side; WARPS fair-line prior agrees with the spread side (+0.5 pts); WARPS moneyline overlay: HOME +8.6% EV |
| W2 SEA@ARI | play | play | spread | HOME | standard | Selector isolated spread HOME; Signals: sharp, team_rating; Value-gap alignment conflicts with the side; WARPS fair-line prior conflicts toward AWAY; WARPS moneyline overlay: HOME +11.3% EV |
| W2 JAX@DEN | play | play | spread | AWAY | standard | Selector isolated spread AWAY; Signals: sharp, team_rating; Value-gap alignment supports the side; WARPS fair-line prior conflicts toward HOME; WARPS moneyline overlay: AWAY +6.5% EV |
| W2 WAS@DAL | play | play | spread | AWAY | standard | Selector isolated spread AWAY; Signals: sharp, team_rating; Value-gap alignment conflicts with the side; WARPS fair-line prior agrees with the spread side (+1.0 pts); WARPS moneyline overlay: AWAY +23.6% EV |
...
| W2 CIN@HOU | lean | watch |  |  | watch | Signals: sharp, injury; WARPS moneyline overlay: HOME +102.4% EV |
| W2 DET@BUF | pass | pass |  |  | none | WARPS moneyline overlay: AWAY +541.3% EV |
| W2 MIN@CHI | pass | pass |  |  | none | WARPS moneyline overlay: AWAY +34.0% EV |
| W2 NO@BAL | pass | pass |  |  | none | WARPS moneyline overlay: AWAY +116.1% EV |
...
| W2 PIT@NE | lean | watch |  |  | watch | WARPS moneyline overlay: AWAY +184.2% EV |
...
| W2 LV@LAC | lean | watch |  |  | watch | Signals: sharp; WARPS moneyline overlay: AWAY +23.3% EV |