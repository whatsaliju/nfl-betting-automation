...
| 3 | SF | ARI@SF | 74.4% | 66.5 | primary | WARPS 66.5% blended with market 78.7% → 74.4%; Home-field survivor spot; Division game raises upset volatility; Save risk: 1 future elite spot(s) |
| 4 | MIN | MIA@MIN | 77.5% | 75.1 | primary | WARPS 64.1% blended with market 84.7% → 77.5%; Home-field survivor spot |
...
| 10 | IND | MIA@IND | 65.9% | 63.5 | secondary | WARPS win probability 65.9%; Home-field survivor spot |
| 11 | LAC | NYJ@LAC | 68.3% | 68.3 | primary | WARPS win probability 68.3%; Home-field survivor spot; Low future opportunity cost |
| 12 | JAX | TEN@JAX | 71.4% | 67.2 | primary | WARPS win probability 71.4%; Home-field survivor spot; Division game raises upset volatility |
| 13 | SEA | DAL@SEA | 70.9% | 69.7 | primary | WARPS win probability 70.9%; Home-field survivor spot |
| 14 | DET | TEN@DET | 71.3% | 70.1 | primary | WARPS win probability 71.3%; Home-field survivor spot |
...
| 3 | 500 | top_heavy | SF (74.4%) | SF (82.5) | DET (17.4% public) |
| 4 | 25 | top_heavy | MIN (77.5%) | MIN (73.7) | MIN (15.1% public) |
| 4 | 100 | top_heavy | MIN (77.5%) | MIN (75.6) | BAL (20.6% public) |
| 4 | 500 | top_heavy | MIN (77.5%) | BAL (89.5) | BAL (20.6% public) |
...
| 8 | 25 | top_heavy | CIN (62.4%) | CIN (61.5) | CIN (8.3% public) |
| 8 | 100 | top_heavy | CIN (62.4%) | CIN (63.4) | CIN (9.8% public) |
| 8 | 500 | top_heavy | CIN (62.4%) | GB (74.5) | GB (10.4% public) |
| 9 | 25 | top_heavy | SF (71.1%) | SF (69.9) | SF (15.7% public) |
| 9 | 100 | top_heavy | SF (71.1%) | SF (72.5) | SF (17.2% public) |
| 9 | 500 | top_heavy | SF (71.1%) | SF (87.4) | SF (17.2% public) |
| 10 | 25 | top_heavy | IND (65.9%) | IND (63.3) | IND (8.0% public) |
| 10 | 100 | top_heavy | IND (65.9%) | IND (65.0) | IND (9.5% public) |
| 10 | 500 | top_heavy | IND (65.9%) | IND (74.7) | IND (9.5% public) |
| 11 | 25 | top_heavy | LAC (68.3%) | LAC (67.2) | LAC (9.4% public) |
| 11 | 100 | top_heavy | LAC (68.3%) | LAC (68.9) | LAC (10.9% public) |
| 11 | 500 | top_heavy | LAC (68.3%) | DEN (79.8) | KC (14.6% public) |
| 12 | 25 | top_heavy | JAX (71.4%) | JAX (66.9) | JAX (10.0% public) |
| 12 | 100 | top_heavy | JAX (71.4%) | JAX (68.6) | JAX (11.5% public) |
| 12 | 500 | top_heavy | JAX (71.4%) | JAX (78.4) | JAX (11.5% public) |
| 13 | 25 | top_heavy | SEA (70.9%) | SEA (68.7) | SEA (11.1% public) |
| 13 | 100 | top_heavy | SEA (70.9%) | SEA (70.6) | SEA (12.6% public) |
| 13 | 500 | top_heavy | SEA (70.9%) | SEA (81.5) | SEA (12.6% public) |
| 14 | 25 | top_heavy | DET (71.3%) | DET (68.6) | DET (14.8% public) |
| 14 | 100 | top_heavy | DET (71.3%) | DET (71.1) | DET (16.3% public) |
| 14 | 500 | top_heavy | DET (71.3%) | DET (85.1) | DET (16.3% public) |
| 15 | 25 | top_heavy | LAR (69.7%) | LAR (66.5) | LAR (12.8% public) |
| 15 | 100 | top_heavy | LAR (69.7%) | LAR (68.8) | LAR (14.3% public) |
| 15 | 500 | top_heavy | LAR (69.7%) | LAR (81.8) | LAR (14.3% public) |
| 16 | 25 | top_heavy | DET (66.3%) | DET (65.0) | DET (11.7% public) |
| 16 | 100 | top_heavy | DET (66.3%) | DET (67.3) | DET (13.2% public) |
| 16 | 500 | top_heavy | DET (66.3%) | DET (80.7) | DET (13.2% public) |
| 17 | 25 | top_heavy | JAX (69.1%) | JAX (67.9) | JAX (9.9% public) |
| 17 | 100 | top_heavy | JAX (69.1%) | JAX (69.7) | JAX (11.4% public) |
| 17 | 500 | top_heavy | JAX (69.1%) | JAX (80.3) | JAX (11.4% public) |
| 18 | 25 | top_heavy | BUF (73.8%) | BUF (69.3) | BUF (15.9% public) |
| 18 | 100 | top_heavy | BUF (73.8%) | BUF (71.7) | BUF (17.4% public) |
| 18 | 500 | top_heavy | BUF (73.8%) | BUF (85.4) | BUF (17.4% public) |
